...
public class SoupwoodLogBlock extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:soupwood_log")
	public static final Block block = null;
	public SoupwoodLogBlock(SoupTheModModElements instance) {
		super(instance, 98);
	}
