...
public class SoupSteelCasingBlock extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:soup_steel_casing")
	public static final Block block = null;
	public SoupSteelCasingBlock(SoupTheModModElements instance) {
		super(instance, 113);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(10f, 10f).lightValue(0).harvestLevel(3)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("soup_steel_casing");
		}
