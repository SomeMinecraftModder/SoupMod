...
public class HotsoupBlock extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:hotsoup")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("soup_the_mod:hotsoup_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public HotsoupBlock(SoupTheModModElements instance) {
		super(instance, 72);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("soup_the_mod:blocks/hot_soup_tex"), new ResourceLocation("soup_the_mod:blocks/hot_soup_not_still"))
				.luminosity(5).density(1000).viscosity(1000)).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("hotsoup");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("hotsoup_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.LAVA)) {
		}.setRegistryName("hotsoup"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("hotsoup_bucket"));
	}
