...
public class Souppier_oreBlockBlock extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:souppier_ore_block")
	public static final Block block = null;
	public Souppier_oreBlockBlock(SoupTheModModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("souppier_ore_block");
		}
