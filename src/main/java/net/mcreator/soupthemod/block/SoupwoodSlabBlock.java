...
public class SoupwoodSlabBlock extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:soupwood_slab")
	public static final Block block = null;
	public SoupwoodSlabBlock(SoupTheModModElements instance) {
		super(instance, 102);
	}
