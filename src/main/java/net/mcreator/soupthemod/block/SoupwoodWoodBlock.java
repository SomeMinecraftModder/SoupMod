...
public class SoupwoodWoodBlock extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:soupwood_wood")
	public static final Block block = null;
	public SoupwoodWoodBlock(SoupTheModModElements instance) {
		super(instance, 97);
	}
