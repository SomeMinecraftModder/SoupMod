...
public class SoupwoodPlanksBlock extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:soupwood_planks")
	public static final Block block = null;
	public SoupwoodPlanksBlock(SoupTheModModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("soupwood_planks");
		}
