...
public class SouppiergemItem extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:souppiergem")
	public static final Item block = null;
	public SouppiergemItem(SoupTheModModElements instance) {
		super(instance, 75);
	}
