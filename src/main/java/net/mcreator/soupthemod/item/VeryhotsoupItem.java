...
import net.mcreator.soupthemod.procedures.VeryhotsoupFoodEatenProcedure;
...
public class VeryhotsoupItem extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:veryhotsoup")
	public static final Item block = null;
	public VeryhotsoupItem(SoupTheModModElements instance) {
		super(instance, 83);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				VeryhotsoupFoodEatenProcedure.executeProcedure($_dependencies);
			}
