...
public class RedstoneSoupItem extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:redstone_soup")
	public static final Item block = null;
	public RedstoneSoupItem(SoupTheModModElements instance) {
		super(instance, 117);
	}
