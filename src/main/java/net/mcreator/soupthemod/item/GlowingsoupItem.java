...
public class GlowingsoupItem extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:glowingsoup")
	public static final Item block = null;
	public GlowingsoupItem(SoupTheModModElements instance) {
		super(instance, 38);
	}
