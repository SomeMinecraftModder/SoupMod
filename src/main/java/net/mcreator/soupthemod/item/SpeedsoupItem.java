...
import net.mcreator.soupthemod.procedures.SpeedsoupFoodEatenProcedure;
...
public class SpeedsoupItem extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:speedsoup")
	public static final Item block = null;
	public SpeedsoupItem(SoupTheModModElements instance) {
		super(instance, 81);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				SpeedsoupFoodEatenProcedure.executeProcedure($_dependencies);
			}
