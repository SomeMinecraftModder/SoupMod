...
public class SoupItem extends SoupTheModModElements.ModElement {
	@ObjectHolder("soup_the_mod:soup")
	public static final Item block = null;
	public SoupItem(SoupTheModModElements instance) {
		super(instance, 1);
	}
