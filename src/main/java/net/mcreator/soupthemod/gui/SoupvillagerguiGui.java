...
import net.mcreator.soupthemod.procedures.SoupvillagerguithingProcedure;
...
public class SoupvillagerguiGui extends SoupTheModModElements.ModElement {
	...
	public SoupvillagerguiGui(SoupTheModModElements instance) {
		super(instance, 77);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("soupvillagergui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 9, 39) {
			}));
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 41, 39) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				SoupTheModMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("soup_the_mod:textures/soupvillagergui.png");
		@Override
		...
		if (buttonID == 0) {
			{
				...
				SoupvillagerguithingProcedure.executeProcedure($_dependencies);
			}
		}
	}
