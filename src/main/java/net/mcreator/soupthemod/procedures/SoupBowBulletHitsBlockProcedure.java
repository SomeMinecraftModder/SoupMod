	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				SoupTheModMod.LOGGER.warn("Failed to load dependency x for procedure SoupBowBulletHitsBlock!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				SoupTheModMod.LOGGER.warn("Failed to load dependency y for procedure SoupBowBulletHitsBlock!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				SoupTheModMod.LOGGER.warn("Failed to load dependency z for procedure SoupBowBulletHitsBlock!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SoupTheModMod.LOGGER.warn("Failed to load dependency world for procedure SoupBowBulletHitsBlock!");
			return;
		}
